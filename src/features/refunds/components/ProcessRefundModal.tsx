...
const ProcessRefundForm: React.FC<ProcessRefundFormProps> = ({ refund, onClose, onSubmit }) => {
  const [refundAmount, setRefundAmount] = useState<number>(refund.refund_amount)
